...
const About = () => {
  return (
    <>
      <div className="md:max-w-7xl mx-auto flex  flex-col justify-center items-center pt-36 text-slate-700 dark:text-gray-300">
        <div className="bg-white/30 w-fit self-start ml-32">
          <ActiveLastBreadcrumb
            path={`${i18n.t("home")}/${i18n.t("aboutPage.title")}`}
          />
        </div>

        <div className="flex justify-center md:justify-between items-center md:mt-10  mt-24 md:mb-36">
          <div className="flex flex-col gap-10 items-center md:items-start justify-center max-w-lg mx-8 ">
