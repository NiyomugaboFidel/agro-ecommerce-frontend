...
const Contact = () => {
  return (
    <div className="md:max-w-7xl md:mx-auto flex flex-col max-w-[1440px] pt-36 gap-20 justify-center md:px-20 dark:text-gray-300">
      <div className="bg-white/30 w-fit md:ml-7 mx-5">
        ...
        <div className="shadow  w-full lg:w-[340px] h-[457px] flex flex-col gap-8 py-10 px-8 rounded">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm">
                {i18n.t("accountPage.phoneNumber")}: +250 788 878 987
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm">
                {i18n.t("contactPage.emails")}: customer@abbasMarket.com
              </p>
              <p className="text-sm">
                {i18n.t("contactPage.emails")}: support@abbasMarket.com
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col lg:flex-row gap-4">
              <input
                ...
                required
                className="lg:w-[235px] rounded bg-gray-100 dark:bg-white/10 dark:text-gray-300 bg-opacity-100 px-4 py-3 text-gray-400 text-base focus:border outline-none focus:border-gray-300  "
              />
              <input
                type="email"
                placeholder={i18n.t("contactPage.yourEmail")}
                required
                className="lg:w-[235px] rounded bg-gray-100 dark:bg-white/10 bg-opacity-100 px-4 py-3 text-gray-400 text-base focus:border outline-none focus:border-gray-300  "
              />
              <input
                type="tel"
                placeholder={i18n.t("accountPage.phoneNumber")}
                required
                className="lg:w-[235px] rounded bg-gray-100 dark:bg-white/10 bg-opacity-100 px-4 py-3 text-gray-400 text-base focus:border outline-none focus:border-gray-300  "
              />
            </div>
            <textarea
              ...
              required
              className="min-h-[50px] h-[207px] rounded bg-gray-100 dark:bg-white/10 bg-opacity-100 px-4 py-3 text-gray-400 text-base focus:border outline-none focus:border-gray-300  "
            />
