  ...
  return (
    <div className="flex justify-between md:justify-around items-center md:gap-4 md:ml-4 ">
      <Link to="/wishlist">
        ...
        >
          <span
            className={`absolute ml-5 mb-5 px-1 rounded-full text-white bg-slate-500 text-sm ${
          ...
          >
            <path
              ...
              className="stroke-[#64748b] dark:stroke-gray-300"
              strokeWidth="1.6"
              strokeLinecap="round"
        ...
        <>
          ...
          >
            <div className="relative">
              ...
              />
              <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-white bg-green-400 shadow-gray-300 shadow-2xl"></span>
            </div>
          </IconButton>
        </>
      )}
