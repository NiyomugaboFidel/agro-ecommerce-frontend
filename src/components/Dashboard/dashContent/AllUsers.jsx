...
import Search from "../../common/components/ui/DashSearch";
import { CiCirclePlus } from "react-icons/ci";
import ReusableTable from "./../../common/components/ui/ReusableTableUsers";
import {
  getUsers,
  updateUserActive,
  updateUserRole,
...
import UserEditModal from "../../common/components/ui/EditUserModel";
...
const AllUsers = () => {
  ...
  return (
    <section className="mx-7 mt-5 border dark:border-gray-700 rounded-lg p-4 max-w-[1440px]">
      <div className="flex justify-between text-gray-600 dark:text-gray-300 mb-10">
        <div className="flex gap-2 w-[20%]">
          <h1 className="text-lg font-bold">{i18n.t("dashboard.users.allUsers")}</h1>
          <AvatarGroup max={3} className="ml-4">
            ...
            {!!surplus && (
              <Avatar sx={{ fontSize: "12", width: "30px", height: "30px" }}>
                +{surplus}
              </Avatar>
            )}
          </AvatarGroup>
        ...
        <div className="flex w-[70%]">
          <Search
            placeholder={i18n.t("dashboard.users.findUser")}
            ...
            <div className="relative flex items-center gap-8">
              <div className="relative">
                <button
                  ...
                  className="flex gap-1 text-sm font-semibold items-center"
                >
                  <CiCirclePlus size={20} />
                  {i18n.t("dashboard.users.role")}
                </button>
                {roleDropdownOpen && (
                  <div className="absolute bg-white dark:bg-gray-900 dark:text-gray-300 border dark:border-gray-700 mt-2 p-2 z-10">
              ...
              <div className="relative">
                ...
                >
                  <CiCirclePlus size={20} />
                  {i18n.t("dashboard.users.status")}
                </button>
                {statusDropdownOpen && (
                  <div className="absolute dark:bg-gray-900 dark:border-gray-700 bg-white border mt-2 p-2 z-10">
