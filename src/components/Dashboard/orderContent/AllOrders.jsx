...
const AllOrders = () => {
  ...
  if (loading) {
    return (
      <div className="fixed top-0 left-0 w-full h-full text-yellow-500 flex items-center justify-center dark:bg-darkTheme bg-white bg-opacity-75 z-50">
        <FaSpinner className="animate-spin mr-2" />
        <span>{i18n.t("dashboard.orders.loading")}</span>
      </div>
    );
  }
    ...
    <section className="px-6 dark:bg-darkTheme dark:text-gray-300 bg-gray-100 h-full py-8">
      <div className="flex flex-col gap-4 mb-4">
        <h2 className="text-xl font-bold">
          {i18n.t("dashboard.orders.allOrders")}
        </h2>
      ...
      <div className="w-full overflow-auto">
        <table className="min-w-full dark:bg-darkTheme dark:border-gray-700 bg-white border border-gray-200 table-fixed">
          ...
          <tbody className="text-gray-600 dark:text-gray-300 text-xs font-light">
            {paginatedItems.length === 0 ? (
              <tr>
                <td colSpan="9" className="text-center py-4">
                  {i18n.t("dashboard.orders.noOrderFound")}
                </td>
              </tr>
            ) : (
              paginatedItems.map((order) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-6 text-left">
                      CFA {order.totalPrice.toLocaleString()}
                    </td>
                    <td className="py-3 px-6 text-left">
                      {totalQuantity} Units
                    </td>
