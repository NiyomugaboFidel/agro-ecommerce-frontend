...
const Service = ({ icon, value, description }) => {
  return (
    <Box className="flex max-w-xs gap-6 items-center justify-center flex-col bg-white dark:bg-zinc-300 px-4 py-8  ">
      {icon}
...
const Services = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-8  max-w-[1440px] self-center text-blue-900">
      <h1 className="text-center text-3xl font-bold ">Why choose Team Tchad Export Marketplace?</h1>
          ...
          icon={
            ...
            >
              <path
                ...
                fill="#1e3a8a"
              />
              <circle cx="40.5" cy="40" r="29" fill="#1e3a8a" />
          ...
          icon={
            ...
            >
              <path
                ...
                fill="#1e3a8a"
              />
              <circle cx="40" cy="40" r="29" fill="#1e3a8a" />
